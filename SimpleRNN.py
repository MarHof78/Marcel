...
def train_SimpleRNN(x_train, y_train, x_test, y_test, scaler, seq_size):
    """Trains a model with two simple recurrent layers and one recurrent output layer
