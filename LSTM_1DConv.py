...
def train_LSTM_1DConv(x_train, y_train, x_test, y_test, scaler, seq_size):
    ...
    model = Sequential([
        keras.layers.LSTM(20, input_shape=[None, seq_size], return_sequences=True),
